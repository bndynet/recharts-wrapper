...
var ChartLegendContent = (function (_super) {
    ...
    ChartLegendContent.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "customized-legend", style: {
            ...
            this.props.series.map(function (serie, index) {
                ...
                return (React.createElement("span", { key: "legend-item-" + index, className: classnames_1.default("recharts-legend-item", inactive && classes && classes.itemInactive), onClick: function () { return _this.handleLegendItemClick(serie); }, style: itemStyles },
                    React.createElement(recharts_1.Surface, { width: iconSize, height: iconSize, viewBox: {
                            x: 0,
                            y: 0,
                            width: ICON_SIZE,
                            height: ICON_SIZE
    ...
    ChartLegendContent.prototype.renderIcon = function (serie, inactive) {
        ...
        return inactive ? (React.createElement(recharts_1.Symbols, { fill: "none", strokeWidth: 4, stroke: color, cx: halfSize, cy: halfSize, size: ICON_SIZE - 10, sizeType: "diameter", type: serie.legendIconType || "circle" })) : (React.createElement(recharts_1.Symbols, { fill: color, cx: halfSize, cy: halfSize, size: ICON_SIZE - 10, sizeType: "diameter", type: serie.legendIconType || "circle" }));
    };
