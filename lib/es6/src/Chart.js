...
var Chart = (function (_super) {
    ...
    Chart.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classNames(classes && classes.root, this.props.className), style: { width: this.props.width, height: height } },
            React.createElement(ResponsiveContainer, { width: "100%", height: "100%" },
                React.createElement(ComposedChart, { data: this.state.data },
                    ...
                    React.createElement(Legend, { height: this.props.legendHeight || 45, iconType: this.props.legendItemIconType || "square", onClick: this.onLegendClick, content: function (props) { return (React.createElement(ChartLegendContent, __assign({}, props, { series: _this.props.series, onItemClick: _this.onLegentItemClick, classes: {
